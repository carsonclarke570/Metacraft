...
/*
The Mob or Collective will not do anything.
*/
void no_ai(void *ptr) {
...
/*
sleeps upside down in caves durring the day and
flies around outside the cave entrance at night.
*/
void bat_ai(Mob *mob) {
    if (0) {// if (no events and no goal) do;
        // move
    } else {// decide
        //
    }
    // find roost
    // choose next flight destination
}
...
/*
A stationed defense of Mobs at various locations
*/
void guards_ai(Collective *collective) {
...
/*
A perimeter defense that follows a route.
*/
void patrol_ai(Collective *collective) {
...
An offensive force.
*/
void army_ai(Collective *collective) {

}



void village_ai(Collective *collective) {

}

/*
Mines resources.
Consumes tools and resources just like players would.
Builds mineshaft structures as needed.

*/
void miners_ai(Collective *collective) {

}



void farmers_ai(Collective *collective) {

}



void foragers_ai(Collective *collective) {

}



void builders_ai(Collective *collective) {

}


void herd_ai(Collective *collective) {

}



void school_ai(Collective *collective) {

}



void flock_ai(Collective *collective) {
